      ...
      <Dialog className='!bg-[#1c1f2e] !rounded-2xl p-6 !w-full' size='lg' open={open} handler={handleOpen}>
        <DialogHeader className='flex !px-0 items-center justify-between'>
            <div className='flex'>
              ...
              <h3 className='text-white ml-2'>Schedule Meeting</h3>
            </div>
            <div className='flex items-center'>
              ...
              <Button onClick={handleOpen} size="sm" className="!text-white border ml-3 bg-[#0e78f9] border-grey-800 !px-4 capitalize flex items-center" variant="text">Save</Button> 
            </div>
        </DialogHeader>
        <DialogBody className='py-6 !px-0 !w-full !block border-y !text-white border-[#31364d]'>
            ...
            <div className='flex justify-between w-full border-y  border-[#31364d]'>
              <div className='w-full py-5'>
                ...
                <DayPicker
                    styles={{
                      ...
                      nav_button_next: {backgroundColor: '#242736', borderRadius: '10px', fontSize: '14px',  margin: '1px', border: '1px solid #31364d'},
                      nav_button_previous: {backgroundColor: '#242736', borderRadius: '10px', fontSize: '14px',  margin: '1px', border: '1px solid #31364d'}
                    }}
                    mode="single"
                    selected={selected}
              ...
              <div className='w-full pl-5 border-l border-[#31364d]'>
                  ...
                  <div className='w-full'>
                     ...
                     <div className='my-6'>
                        ...
                        <div className='flex items-center justify-between mt-2 gap-x-3'>
                          ...
                          <Button size="sm" className="!text-white border bg-[#8e44ad] border-grey-800 !px-4 capitalize flex items-center" variant="text">Copy</Button> 
                        </div>
                     </div>
        ...
        <DialogFooter className='text-left w-full'>
          ...
          <div className='text-left w-full'>
             ...
             <div className='w-full !text-grey-300 flex justify-between items-center'>
