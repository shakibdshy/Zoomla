  ...
  return (
    <div>
        <Fragment>
            ...
            <div className={`${(open === 1) && "bg-[#212534] , text-[18px]"} hover:bg-[#212534] !text-grey-500 flex rounded-lg p-2 justify-between items-center font-bold`}>
                <p className='text-white flex items-center font-bold'>
                  <span className='text-xl text-grey-500'><BiMessageRoundedDots /></span>
                ...
                <div className='max-h-[420px] overflow-auto'>
                  {
                    data.map(i => (
                      <>
                        <div className='flex cursor-pointer text-grey-500 hover:text-white rounded-lg p-1.5 my-2 gap-3'>
                          <div>
                            <Image
