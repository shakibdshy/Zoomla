...
function JoinMeetingModal({ setMeetOpen, open }: props) {
  ...
  return (
    <Fragment>
      <Dialog className='flex !bg-[#4b69c294] items-center justify-end sm:justify-center !w-full' size='xxl' open={open} handler={handleOpen}>
        <div className='w-full sm:w-[60%] lg:w-[40%] h-[350px] overflow-y-auto !bg-[#1c1f2e] rounded-t-2xl sm:!rounded-2xl p-3 sm:p-6'>
